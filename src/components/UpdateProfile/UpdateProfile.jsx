...
const UpdateProfile = () => {
  ...
  return (
    <div>
      ...
      <div className="min-h-[650px] py-5 lg:py-0 flex items-center justify-center bg-gradient-to-r from-yellow-500 via-red-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="card lg:card-side lg:w-4/12 bg-gradient-to-r from-[#c2e9fb] via-[#fefefe] to-[#fceabb] p-5 rounded-lg gap-5">
          ...
          <div className="lg:w-6/12">
            <form onSubmit={handleUpdate}>
              ...
              <button
                type="submit"
                className="btn mt-4 bg-gradient-to-r from-pink-500 via-red-400 to-yellow-400 text-white"
              >
                Update
              </button>
            </form>
